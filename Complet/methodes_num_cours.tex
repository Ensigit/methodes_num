...
%\includeonly{methodes_num0}
\newlength{\larg}
\setlength{\larg}{14.5cm}

% Crédit page de garde : http://www.grappa.univ-lille3.fr/FAQ-LaTeX/6.67.html
\title{
...
\include{methodes_num0}
\include{methodes_num1}
\include{methodes_num3}
% \include{methodes_num4}
\include{methodes_num5}
\include{methodes_num6}
\include{methodes_num7}
